...
export default function AboutPage() {
  return (
    <>
      ...
      <Reveal className="mt-3 space-y-4" delay={0.1}>
        <p className="max-w-[64ch] text-label leading-6 text-ink">
          <span className="highlight-span">{site.aboutIntro}</span>
        </p>
        <p className="max-w-[64ch] text-label leading-6 text-ink-2">
