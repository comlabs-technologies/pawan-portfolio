...
/** Grouped entries under a compact shadowed label. */
export function Timeline({ groups }: { groups: CredentialGroup[] }) {
            ...
            {group.entries.map((entry) => (
              ...
              >
                ...
                <div className="min-w-0">
                  <p className="text-label font-medium text-ink">{entry.title}</p>
                  <motion.p
